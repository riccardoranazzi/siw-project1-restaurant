...
public class AuthConfiguration {
	...
	protected SecurityFilterChain configure(final HttpSecurity httpSecurity) 
	    ...
	    httpSecurity
	        ...
	        .requestMatchers(HttpMethod.GET, "/", "/index", "/css/**", "/images/**", "favicon.ico", "/login", "/register", "/menu", "/rest/**", "rest/product/**", "/registrationSuccessfull", "/login/success", "/login/error", "/product/**", "/about").permitAll()
